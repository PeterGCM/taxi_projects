...
def run(pkl_dir):
    ...
    from_date = date(int(f_yyyymmdd[:'yyyy']), int(f_yyyymmdd['yyyy':'yyyymm']), int(f_yyyymmdd['yyyymm':]))
    to_date = date(int(t_yyyymmdd[:'yyyy']), int(t_yyyymmdd['yyyy':'yyyymm']), int(t_yyyymmdd['yyyymm':]))
