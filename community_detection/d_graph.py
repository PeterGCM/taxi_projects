...
def process_within_month(yymm):
    ...
    #
    day_aggregation_graph(yymm, middle_dt0, middle_dt0 + datetime.timedelta(days=1))
    day_aggregation_graph(yymm, middle_dt0 + datetime.timedelta(days=2), middle_dt0 + datetime.timedelta(days=3))
