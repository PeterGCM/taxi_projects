...
def run():
    ...
    for df, num_unit, num_chart_fn, fare_unit, fare_chart_fn in [(whole_df,
                                                                    1000, charts_dir + '/timeslot_wh_num',
                                                                    1000000, charts_dir + '/timeslot_wh_fare'),
                                                                 (ap_df,
                                                                    1000, charts_dir + '/timeslot_ap_num',
                                                                    1000000, charts_dir + '/timeslot_ap_fare'),
                                                                 (ns_df,
                                                                    1000, charts_dir + '/timeslot_ns_num',
                                                                    1000, charts_dir + '/timeslot_ns_fare')]:
        ...
        for hour, dow, totalFare in hour_dow_totalFare.values:
            yss[DAY_OF_WEEK.index(dow)][hour] += (totalFare / CENT) / float(fare_unit)
        #
