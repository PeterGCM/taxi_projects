...
from information_boards.a_overall_analysis import ap_tm_num_dur_fare_fpath, ns_tm_num_dur_fare_fpath
from information_boards.a_overall_analysis import NUM, DUR, FARE
