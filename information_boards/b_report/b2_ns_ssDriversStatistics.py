...
from information_boards import ssDriversStatistics_ns_fpath
...
def run():
    with open(ssDriversStatistics_ns_fpath, 'wb') as w_csvfile:
...
def aggregate_dayBased(yymm):
    ...
    for dd in days:
        ...
        for did in ssDrivers:
            ...
            #
            with open(ssDriversStatistics_ns_fpath, 'a') as w_csvfile:
                writer = csv.writer(w_csvfile, lineterminator='\n')
