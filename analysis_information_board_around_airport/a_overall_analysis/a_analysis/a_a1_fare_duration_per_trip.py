...
def ns_analysis():
    ...
    ns_in_dur = (gb.sum()['total-dur'][DInNS_PInNS] + gb.sum()['total-dur'][DOutNS_PInNS]) / MINUTE
    #
    ...
    ns_out_dur = (gb.sum()['total-dur'][DInNS_POutNS] + gb.sum()['total-dur'][DOutNS_POutNS]) / MINUTE
    #
